A Python script to rename Windows files from random names to incremental numbers. This script is particularly useful for cleaning up image dataset filenames.
